...
% TODO(authors): Snapp asks a non-public dataset to say WHY it is not public.
% Add the reason to the sentence below before submitting.
\textbf{Data availability.} The dataset analysed here was generated in the course
of~\cite{zelaci2021}, is not deposited in a public repository, and is available
