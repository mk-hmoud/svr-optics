...
\section{Methodology}
In this section, we detail the data preparation pipeline and the mathematical foundations of the regression models employed in this study. Given the high-fidelity nature of the FV-FEM simulations, the methodology focuses on maintaining physical consistency while maximizing predictive accuracy in a small-data regime.
